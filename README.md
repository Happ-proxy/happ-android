...
|                                                                            | [Download Beta APK](https://github.com/Happ-proxy/happ-android/releases/download/2.7.0/Happ_beta.apk) | Linux: [alpha](https://github.com/Happ-proxy/happ-desktop/releases/latest/download/Happ.linux.x86.AppImage.zip) |
